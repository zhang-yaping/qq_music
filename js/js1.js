window.onload=function(){
	...
	var yinyueku=[
      {name:'一次就好',src:'MP3/一次就好.mp3',geshou:'杨宗纬',duration:'4:26'},
      {name:'梦一场',src:'MP3/梦一场.mp3',geshou:'那英',duration:'3:52'},
      {name:'老鼠爱大米',src:'MP3/老鼠爱大米.mp3',geshou:'杨臣刚',duration:'5:04'},
      {name:'南山南',src:'MP3/南山南.mp3',geshou:'马頔',duration:'5:36'}]
